...
export enum GeneralActionsType {
  ...
  UPDATE_GROUPS_AND_WORDS = '[GENERAL] Update groups and words'
}


export const setCurrentLanguage = createAction(GeneralActionsType.SET_CURRENT_LANGUAGE, props<{ language: LanguageInterface }>())
export const updateGroupsAndWordsAction = createAction(GeneralActionsType.SET_CURRENT_LANGUAGE, props<{ isUpdate: boolean }>())
