...
class LanguagesRoutes {
    ...
    routes() {
        ...
        this.router.get("/getUserLanguages", passport_1.default.authenticate("jwt", { session: false }), this.languagesController.getUserLanguages);
        ...
        this.router.post("/addUserLanguages", passport_1.default.authenticate("jwt", { session: false }), this.languagesController.addUserLanguages);
        this.router.post("/deleteUserLanguage", passport_1.default.authenticate("jwt", { session: false }), this.languagesController.deleteUserLanguage);
    }
}
